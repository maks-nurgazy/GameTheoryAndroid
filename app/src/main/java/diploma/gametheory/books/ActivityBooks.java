...
public class ActivityBooks extends AppCompatActivity {
    ...
    private void permission() {
        if (ContextCompat.checkSelfPermission(getApplicationContext(),
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(ActivityBooks.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                Toast.makeText(this, "Please Grant Permission", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(ActivityBooks.this,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION)
        {
            ...
            {
                Toast.makeText(this, "Please Grant Permmission ", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
