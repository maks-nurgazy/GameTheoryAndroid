package diploma.gametheory.quizzes;
...
import diploma.gametheory.retrofit.QuizService;
...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String difficulty = intent.getStringExtra(ActivityQuizzes.EXTRA_DIFFICULTY);
        ...
        if (savedInstanceState == null) {
            ...
            QuizService quizService =
                    ServiceGenerator.createService(QuizService.class, username, password);
            Call<ArrayList<Question>> call = quizService.getQuestions(difficulty);
            call.enqueue(new Callback<ArrayList<diploma.gametheory.models.Question>>() {
                @Override
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            if (currentQuestion.getType().equals("TFQ")){
                ...
                rb4.setText(currentQuestion.getOptD());
            }
            ...
            COUNTDOWN_IN_MILLIS = currentQuestion.getTimer();
